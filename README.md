Mir version of the DLang Tour
==============================================

[![Build Status](https://travis-ci.org/dlang-tour/mir.svg?branch=master)](https://travis-ci.org/dlang-tour/mir)
...
don't hesitate to open an [issue](https://github.com/dlang-tour/mir/issues).
